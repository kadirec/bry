    ...
    @forelse($posts as $p)
      <tr>
        <td>
          ...
          @if($p->is_featured) <span style="display:inline-block; padding:2px 8px; background:var(--a-plum-soft); color:var(--a-plum-deep); border-radius:999px; font-size:11px; margin-left:4px;">⭐ Kategoride öne çıkan</span>@endif
          @if($p->is_featured_all) <span style="display:inline-block; padding:2px 8px; background:var(--a-plum-soft); color:var(--a-plum-deep); border-radius:999px; font-size:11px; margin-left:4px;">🌟 Tümünde öne çıkan</span>@endif
